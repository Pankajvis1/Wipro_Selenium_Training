...
public class Smoke_Regression {
    ...
    public void login() throws InterruptedException {
        ...
        WebElement mobileNumber = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//input[contains(@class,'c3Bd2c') and @type='text']")));

        mobileNumber.sendKeys("7300293160");
    ...
    @Test(priority = 3, groups = {"Smoke"}, alwaysRun = true)
    public void add_to_cart() throws InterruptedException {
        ...
        WebElement product = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//a[@class='pIpigb' and @title='Apple MacBook Air (M5, 2026) M5 - (16 GB/512 GB SSD/Tahoe) MDHE4HN/A']")));
        ...
        WebElement addToCart = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//div[@class='css-g5y9jx' and contains(@style,'z-index: 2')]")));
    ...
    public void view_product_details() throws InterruptedException {
        ...
        WebElement details = wait.until(
                ExpectedConditions.presenceOfElementLocated(
                        By.xpath("//*[name()='svg' and .//*[name()='path' and contains(@d,'m208 96-80 80-80-80')]]/ancestor::*[self::button or self::div][1]")));
    ...
    public void change_Address() throws InterruptedException {
        ...
        WebElement changeBtn = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//div[contains(text(),'Change')]")));
        ...
        WebElement addressName = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//div[contains(text(),'Karol Bagh')]")));
    ...
    public void Change_name() throws InterruptedException {
        ...
        WebElement firstName = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//input[@type='text' and @name='firstName']")));
    ...
    public void removeItem() throws InterruptedException {
        ...
        WebElement removeBtn = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//div[@dir='auto' and normalize-space()='Remove']")));
